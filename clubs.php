...
<section class="gallery" id="gallery">
    ...
    <h1 class="heading">our <span>Clubs & Chapters</span></h1>
    <p style="size: 20px">Details about respective clubs along with Google-form link.</p> 
        <p style="height: 20%, width: 20%"></p>
